...
doc_events = {
	"Payment Entry": {
		"on_submit": "education.education.doctype.fees.fees.update_linked_fees",
		"on_cancel": "education.education.doctype.fees.fees.update_linked_fees",
	},
	"Journal Entry": {
		"on_submit": "education.education.doctype.fees.fees.update_linked_fees",
		"on_cancel": "education.education.doctype.fees.fees.update_linked_fees",
...
scheduler_events = {
	"daily": [
		"education.education.doctype.fees.fees.set_overdue_status",
	],
}
